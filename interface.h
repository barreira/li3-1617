...
typedef struct TCD_istruct *TAD_istruct; // Estrutura principal do programa, que
                                         // contém todos os dados lidos das
 ...
 * de todas as revisões do mesmo. O resultado é ordenado de forma decrescente e,
 * caso existam artigos com um tamanho igual, estes aparecem ordenados pelo
